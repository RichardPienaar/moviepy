...
'''
From moviePY - small editions to concatenate_videoclips in order to make the videos appear in random locations  
'''
def concatenate_videoclips(clips, method="chain", transition=None,
    ...
    if method == "chain":
        ...
        result = CompositeVideoClip( [c.set_start(t).set_position(random.choice(['center','center','center','center', 'center','right','left','top','bottom'])) # Editions to make location random
